...
#Voc is: 24535 but 10273 only (>2)
# maximum length of a sentence
 # Max 58, Median = 17, avg 16
crossval = 20
## Random Seed
seed = 27
...
TSdata = [ ( row["Tweet"] , float( row["Rating"] )  ) for row in csv.DictReader(open("cnn_lstm/test/anger_test1.txt"), delimiter='\t', quoting=csv.QUOTE_NONE) ]
...
for i in EMOS.split():	
	...
	np.savetxt("cnn_lstm/test/pred/"+currentemo+"1.txt", results, newline='\n')
